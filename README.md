...
* [skills-installer](skills-installer) provides a Terraform module that uploads local Assistant skill folders (with `SKILL.md`) into workspace paths under `.assistant/skills/` for the current user or globally under `/Workspace`. See [modules/install-assistant-skills/README.md](skills-installer/modules/install-assistant-skills/README.md).
